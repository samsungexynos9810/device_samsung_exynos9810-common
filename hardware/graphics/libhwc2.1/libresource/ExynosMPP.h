...
public:
    ...
    int32_t setOutBuf(buffer_handle_t outbuf, int32_t fence, ExynosDisplay *display);
    ...
    int32_t setDstReleaseFence(int releaseFence, ExynosDisplay *display = NULL);
    ...
    bool isSupportedHDR(struct exynos_image &src);
    ...
    virtual bool isSupportedFullAfbcChannel(resource_set_t __unused set) { return false; }
